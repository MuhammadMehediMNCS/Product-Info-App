                  ...
                  children: [
                    ListTile(
                      leading: IconButton(
                        ...
                        icon: Image.asset('images/edit.png', height: 22.0, width: 22.0, color: Colors.pink)
                      ),
                      title: Text(product.name ?? 'No Name'),
                      titleTextStyle: const TextStyle(color: Colors.pink, fontFamily: 'TiroBangla-Regular', fontSize: 16.0, fontWeight: FontWeight.bold),
                      subtitle: Text(product.size ?? 'No Size'),
                      subtitleTextStyle: const TextStyle(color: Color(0xFFFCB2E9), fontFamily: 'TiroBangla-Regular', fontSize: 12.0),
                      trailing: Text(product.total ?? '0'),
                      leadingAndTrailingTextStyle: const TextStyle(color: Colors.pink, fontSize: 18.0, fontWeight: FontWeight.bold),
                      onTap: () {
