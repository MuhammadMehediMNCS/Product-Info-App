      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 10.0),
            const Text('বিঃ দ্রঃ বিক্রিত মাল ফেরত হয় না।', style: TextStyle(fontFamily: 'TiroBangla-Regular', fontWeight: FontWeight.bold)),
            const SizedBox(height: 10.0),
            const Align(
              alignment: Alignment.centerRight,
              child: Text('বিক্রেতার স্বাক্ষর', style: TextStyle(fontFamily: 'TiroBangla-Regular', fontWeight: FontWeight.bold))
            ),
            const SizedBox(height: 10.0)
          ],
        ),
